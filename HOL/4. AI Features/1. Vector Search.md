...
Before wrapping up, go ahead and add a few more `EXEC VectorSearch` statements that match up against some of your favorite movies you added earlier in the lab. Have fun querying on the many well-known attributes of your favorite movies!
___
