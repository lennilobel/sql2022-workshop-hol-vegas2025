...
- **Note:** `sp_invoke_external_rest_endpoint` is available today in Azure SQL Database, but is not available in SQL Server 2022. However, it will be available in SQL Server 2025.
