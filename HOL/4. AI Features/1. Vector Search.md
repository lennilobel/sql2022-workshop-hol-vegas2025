...
After pasting in the above code, change the placeholder for the API key (on the `DECLARE @OpenAIApi key` line) to the value supplied by the lab instructor. Then execute the code to create the stored procedure.
