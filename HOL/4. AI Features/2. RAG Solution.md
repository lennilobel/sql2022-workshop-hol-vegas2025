...
This stored procedure is very similar to the `VectorizeText` stored procedure from the previous lab, since they are both calling Azure OpenAI. The key differences in this stored procedure are:  
