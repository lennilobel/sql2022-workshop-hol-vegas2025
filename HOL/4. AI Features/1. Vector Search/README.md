...
1. Create the **VectorizeText** stored procedure
1. **Vectorize** the database
1. Create the **VectorSearch** stored procedure
1. Run **AI Queries**
...
▶ [Step 1: Connecto to SQL Server](https://github.com/lennilobel/sql2022-workshop-hol-vegas2025/blob/master/HOL/4.%20AI%20Features/1.%20Vector%20Search/1.%20Connect%20to%20SQL%20Server.md)
